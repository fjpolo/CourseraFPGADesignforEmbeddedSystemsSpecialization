...
module nios_lab_mm_interconnect_0 (
		...
		input  wire [11:0] nios_instruction_master_address,        //          nios_instruction_master.address
	...
	wire  [11:0] nios_data_master_translator_avalon_universal_master_0_address;              // nios_data_master_translator:uav_address -> nios_data_master_agent:av_address
	...
	wire  [83:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> nios_data_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                          // nios_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [1:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> nios_data_master_agent:rp_channel
	...
	wire  [11:0] nios_instruction_master_translator_avalon_universal_master_0_address;       // nios_instruction_master_translator:uav_address -> nios_instruction_master_agent:av_address
	...
	wire  [83:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> nios_instruction_master_agent:rp_data
	wire         rsp_mux_001_src_ready;                                                      // nios_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire   [1:0] rsp_mux_001_src_channel;                                                    // rsp_mux_001:src_channel -> nios_instruction_master_agent:rp_channel
	...
	wire  [11:0] nios_debug_mem_slave_agent_m0_address;                                      // nios_debug_mem_slave_agent:m0_address -> nios_debug_mem_slave_translator:uav_address
	...
	wire  [84:0] nios_debug_mem_slave_agent_rf_source_data;                                  // nios_debug_mem_slave_agent:rf_source_data -> nios_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [84:0] nios_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios_debug_mem_slave_agent_rsp_fifo:out_data -> nios_debug_mem_slave_agent:rf_sink_data
	...
	wire  [83:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> nios_debug_mem_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                          // nios_debug_mem_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [1:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> nios_debug_mem_slave_agent:cp_channel
	...
	wire  [83:0] nios_data_master_agent_cp_data;                                             // nios_data_master_agent:cp_data -> router:sink_data
	...
	wire  [83:0] nios_instruction_master_agent_cp_data;                                      // nios_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [83:0] nios_debug_mem_slave_agent_rp_data;                                         // nios_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	nios_lab_mm_interconnect_0_router router (
	...
	nios_lab_mm_interconnect_0_router router_001 (
	...
	nios_lab_mm_interconnect_0_router_002 router_002 (
	...
	nios_lab_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (pll_c0_clk),                             //       clk.clk
		.reset              (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lab_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (pll_c0_clk),                             //       clk.clk
		.reset              (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lab_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (pll_c0_clk),                             //       clk.clk
		.reset               (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lab_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (pll_c0_clk),                             //       clk.clk
		.reset              (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lab_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (pll_c0_clk),                             //       clk.clk
		.reset               (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lab_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (pll_c0_clk),                             //       clk.clk
		.reset               (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lab_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
